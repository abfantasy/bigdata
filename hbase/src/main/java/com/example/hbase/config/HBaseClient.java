...
public class HBaseClient {
    ...
    private void init() {
        ...
        try {
            ...
            System.err.println("get admin success");
        } catch (IOException e) {
    ...
    public String selectOneRow(String tableName, String rowKey) throws IOException {
        ...
        // 4. 获取所有单元格
        List<Cell> cellList = result2.listCells();
        ...
        for (Cell cell : result.rawCells()) {
            System.out.println(" 4=> " + Bytes.toString(cell.getQualifierArray(), cell.getQualifierOffset(), cell.getQualifierLength()));
            System.out.println(" 1=> " + Bytes.toString(cell.getValueArray(), cell.getValueOffset(), cell.getValueLength()));
            System.out.println(" 2=> " + Bytes.toString(cell.getFamilyArray(), cell.getValueOffset(), cell.getValueLength()));
            System.out.println(" 3=> " + Bytes.toString(cell.getQualifierArray(), cell.getValueOffset(), cell.getValueLength()));
